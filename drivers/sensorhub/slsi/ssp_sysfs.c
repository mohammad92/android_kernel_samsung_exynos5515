...
//#define SENSORHUB_DUMP_FILE_PATH "/data/log/sensor_reg_dump"//"/data/vendor/w_sensorhub/sensor_reg_dump"
...
static DEVICE_ATTR(sensor_reg_dump, S_IRUGO | S_IWUSR | S_IWGRP, sensorhub_dump_show, sensorhub_dump_store);
