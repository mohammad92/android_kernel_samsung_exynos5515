...
#ifdef CONFIG_COMPAT
#define P61_SET_PWR_COMPAT				_IOW(P61_MAGIC, 0x01, uint32_t)
#define P61_SET_DBG_COMPAT				_IOW(P61_MAGIC, 0x02, uint32_t)
#define P61_SET_POLL_COMPAT				_IOW(P61_MAGIC, 0x03, uint32_t)
#define P61_SET_SPM_PWR_COMPAT			_IOW(P61_MAGIC, 0x04, uint32_t)
#define P61_GET_SPM_STATUS_COMPAT		_IOR(P61_MAGIC, 0x05, uint32_t)
#define P61_SET_THROUGHPUT_COMPAT		_IOW(P61_MAGIC, 0x06, uint32_t)
#define P61_GET_ESE_ACCESS_COMPAT		_IOW(P61_MAGIC, 0x07, uint32_t)
#define P61_SET_POWER_SCHEME_COMPAT		_IOW(P61_MAGIC, 0x08, uint32_t)
#define P61_SET_DWNLD_STATUS_COMPAT		_IOW(P61_MAGIC, 0x09, uint32_t)
#define P61_INHIBIT_PWR_CNTRL_COMPAT	_IOW(P61_MAGIC, 0x0A, uint32_t)
#define ESE_SET_TRUSTED_ACCESS_COMPAT	_IOW(P61_MAGIC, 0x0B, uint32_t)
#define ESE_PERFORM_COLD_RESET_COMPAT	_IOW(P61_MAGIC, 0x0C, uint32_t)
#define PERFORM_RESET_PROTECTION_COMPAT	_IOW(P61_MAGIC, 0x0D, uint32_t)
#define P61_RW_SPI_DATA_COMPAT			_IOWR(P61_MAGIC, 0x0F, uint32_t)
#endif
