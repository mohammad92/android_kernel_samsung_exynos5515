...
#define RM69091_ERR_REG		0xE5
#define RM69091_ERR_OFS		0
#define RM69091_ERR_LEN		1

#define RM69091_ERR_FG_REG		0xEE
#define RM69091_ERR_FG_OFS		0
#define RM69091_ERR_FG_LEN		1
...
static u8 RM69091_ERR[RM69091_ERR_LEN];
static u8 RM69091_ERR_FG[RM69091_ERR_FG_LEN];
...
static struct rdinfo rm69091_rditbl[] = {
	...
	[READ_ERR] = RDINFO_INIT(err, DSI_PKT_TYPE_RD, RM69091_ERR_REG, RM69091_ERR_OFS, RM69091_ERR_LEN),
	[READ_ERR_FG] = RDINFO_INIT(err_fg, DSI_PKT_TYPE_RD, RM69091_ERR_FG_REG, RM69091_ERR_FG_OFS, RM69091_ERR_FG_LEN),
...
static DEFINE_RESUI(err, &rm69091_rditbl[READ_ERR], 0);
static DEFINE_RESUI(err_fg, &rm69091_rditbl[READ_ERR_FG], 0);
...
static struct resinfo rm69091_restbl[] = {
	...
	[RES_ERR] = RESINFO_INIT(err, RM69091_ERR, RESUI(err)),
	[RES_ERR_FG] = RESINFO_INIT(err_fg, RM69091_ERR_FG, RESUI(err_fg)),
...
static struct dumpinfo rm69091_dmptbl[] = {
	...
	[DUMP_ERR] = DUMPINFO_INIT(err, &rm69091_restbl[RES_ERR], show_err),
	[DUMP_ERR_FG] = DUMPINFO_INIT(err_fg, &rm69091_restbl[RES_ERR_FG], show_err_fg),
