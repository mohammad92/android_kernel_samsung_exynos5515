...
static DEFINE_PANEL_MDELAY(large_a2_s0_wait_10msec, 10);
...
static DEFINE_STATIC_PACKET(large_a2_s0_tsp_vsync, DSI_PKT_TYPE_WR, LARGE_A2_S0_TSP_VSYNC, 0);
...
static void *large_a2_s0_init_cmdtbl[] = {
	&DLYINFO(large_a2_s0_wait_10msec),
