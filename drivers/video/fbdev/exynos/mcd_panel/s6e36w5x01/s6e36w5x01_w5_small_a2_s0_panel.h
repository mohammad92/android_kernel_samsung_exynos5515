...
static u8 w5_small_a2_s0_brt_table[S6E36W5X01_TOTAL_STEP][1] = {
	/* Normal 5x51+1 */
...
static u8 w5_small_a2_s0_lpm_brt_table[S6E36W5X01_TOTAL_STEP][1] = {
	/* low 5x4+1 */
...
static u8 W5_SMALL_A2_S0_TSP_VSYNC[] = {
	0xB9,
	0x00, 0x00, 0x14, 0x18, 0x00, 0x00, 0x00, 0x31,
	0x21
};
static DEFINE_STATIC_PACKET(w5_small_a2_s0_tsp_vsync, DSI_PKT_TYPE_WR, W5_SMALL_A2_S0_TSP_VSYNC, 0);
...
static u8 W5_SMALL_A2_S0_SECOND_PMIC_3[] = {
	0xB5,
	0x70
};
static DEFINE_STATIC_PACKET(w5_small_a2_s0_second_pmic_3, DSI_PKT_TYPE_WR, W5_SMALL_A2_S0_SECOND_PMIC_3, 0x58);
